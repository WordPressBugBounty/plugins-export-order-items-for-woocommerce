    ...
    <div id="ags-xoiwc-settings">
        ...
        <div id="ags-xoiwc-settings-tabs-content">
	        ...
	        if (!class_exists('WooCommerce')) {
		        echo('<p class="ags-xoiwc-notification ags-xoiwc-notification-warning">' . esc_html__('This plugin requires that WooCommerce is installed and activated.', 'export-order-items-for-woocommerce') . '</p></div></div>');
		        return;
	        } else if (!function_exists('wc_get_order_types')) {
		        echo('<p class="ags-xoiwc-notification ags-xoiwc-notification-warning">' . esc_html__('The Export Order Items plugin requires WooCommerce 2.2 or higher. Please update your WooCommerce install.', 'export-order-items-for-woocommerce') . '</p></div></div>');
		        return;
	        }
