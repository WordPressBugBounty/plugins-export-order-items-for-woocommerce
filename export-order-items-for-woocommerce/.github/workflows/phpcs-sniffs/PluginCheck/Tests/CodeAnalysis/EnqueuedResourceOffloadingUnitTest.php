...
namespace PluginCheck\Tests\CodeAnalysis;

use PluginCheck\Sniffs\CodeAnalysis\EnqueuedResourceOffloadingSniff;
use PluginCheck\Tests\AbstractSniffUnitTest;
